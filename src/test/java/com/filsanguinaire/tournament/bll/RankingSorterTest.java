...
public class RankingSorterTest {
	...
	@Test
	void shouldPutCoachWithMostPassesFirst() {
		ScoreDTO score1 = ScoreDTO	.builder()
						.coachId(1L)
						.numberOfWins(2)
						.numberOfDraws(2)
		...
		List<ScoreDTO> sortedScores = sorter.passerSort(scores);
	...
	@Test
	void shouldBreakPasserTiesByGeneralRanking() {
		ScoreDTO score1 = ScoreDTO	.builder()
						.coachId(1L)
						.numberOfWins(2)
						.numberOfDraws(2)
	...
	@Test
	void shouldPutCoachWithMostFoulActionsFirst() {
		ScoreDTO score1 = ScoreDTO	.builder()
						.coachId(1L)
						.numberOfWins(2)
						.numberOfDraws(2)
		...
		List<ScoreDTO> sortedScores = sorter.foulerSort(scores);
	...
	@Test
	void shouldBreakFoulerTiesByGeneralRanking() {
		ScoreDTO score1 = ScoreDTO	.builder()
						.coachId(1L)
						.numberOfWins(2)
						.numberOfDraws(2)
